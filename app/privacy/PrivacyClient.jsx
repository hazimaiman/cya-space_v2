...
export default function PrivacyClient({ sections }) {
  useEffect(() => {
      ...
      <section className="relative mx-auto flex max-w-4xl flex-col gap-12">
        <header className="space-y-6 text-center">
          ...
          <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            Your trust matters. This policy explains how project information is
            collected, safeguarded, and used throughout our collaboration.
          </p>
        </header>
